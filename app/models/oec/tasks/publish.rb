  ...
  module Tasks
    class Publish < Base
      ...
      def run_internal
        ...
        pattern = "#{Oec::Tasks::Base.date_format}_%H%M%S"
        ...
        unless @opts[:local_write]
          ...
          pattern = "#{self.class.date_format}_#{self.class.timestamp_format}"
          filename = "#{self.class.name.demodulize.underscore}_task_sftp_#{DateTime.now.strftime pattern}.log"
