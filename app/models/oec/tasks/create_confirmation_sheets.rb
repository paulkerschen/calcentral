module Oec
  module Tasks
    class CreateConfirmationSheets < Base

      include Oec::Validator

      before_task_run Oec::Tasks::SisImport, if: proc { !@opts[:local_write] }
      ...
      def run_internal
        ...
        supervisors = Oec::Worksheets::Supervisors.from_csv @remote_drive.export_csv(supervisors_sheet)
      ...
      def generate_course_confirmation(dept_import_sheet)
        course_confirmation = Oec::Worksheets::CourseConfirmation.new
        sis_import_sheet = Oec::Worksheets::SisImport.from_csv(@remote_drive.export_csv(dept_import_sheet), term_code: @term_code)
      ...
      def generate_supervisor_confirmation(supervisors, course_codes)
        supervisor_confirmation = Oec::Worksheets::SupervisorConfirmation.new
